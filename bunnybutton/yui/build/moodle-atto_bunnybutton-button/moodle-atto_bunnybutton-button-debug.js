YUI.add('moodle-atto_dbunnybutton-button', function (Y, NAME) {
...
/*
 * @package    atto_dbunnybutton
 * @copyright  dbunny 2009 - 2016 With contributions from Joseph Malmsten (joseph.malmsten@gmail.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

/**
 * @module moodle-atto_dbunnybutton-button
 */

/**
 * Atto text editor dbunnybutton plugin.
 *
 * @namespace M.atto_dbunnybutton
 * @class button
...
var COMPONENTNAME = 'atto_dbunnybutton',
    servername = '',
    courseid = '',
    instancename = '',
    idstring = '',
    ...
    Y.namespace('M.atto_dbunnybutton').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
        /**
        ...
        initializer: function () {
            ...
            // Add the dbunnybutton icon/buttons.
            this.addButton({
                icon: 'ed/' + icon,
                iconComponent: 'atto_dbunnybutton',
                buttonName: icon,
        ...
        /**
         * Display the dbunnybutton Dialogue
         *
        ...
        _displayDialogue: function (e, clickedicon) {
            ...
            IFSOURCE = 'https://' + servername +
                    '/dbunny/Pages/Sessions/EmbeddedUpload.aspx' + playlistString + instancestring + idstring;
                        ...
                        for (i = 0; i < ids.length; ++i) {
                            ...
                            if (typeof names[i] !== 'undefined') {
                                thumbnailChunk += "<div width='" + sessionWidth + "'>" +
                                    ...
                                    "href='https://" + servername + '/dbunny/Pages/Viewer.aspx' + idChunk + instancestring + 
                                    "' target='_blank'>" + names[i] + "</a></div>";
                            }

                            thumbnailChunk += "<a href='https://" + servername + '/dbunny/Pages/Viewer.aspx' +
                                idChunk + "' target='_blank'>" +
                                "<img width='128' height='72' alt='" + names[i] + "' src='https://" + 
                                    servername +'/dbunny/PublicAPI/SessionPreviewImage?id=' +
                                    ids[i] + "'></img></a><br></div>";

                            objectstring += "<div style='position: relative;'>" +
                                thumbnailChunk +
                                "<div>" + "<iframe src='https://" + servername + '/dbunny/Pages/Embed.aspx' +
