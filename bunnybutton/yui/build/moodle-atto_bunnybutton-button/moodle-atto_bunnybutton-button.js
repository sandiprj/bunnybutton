YUI.add('moodle-atto_bunnybutton-button', function (Y, NAME) {
 ...
 * @copyright  bunny 2009 - 2016 With contributions from Joseph Malmsten (joseph.malmsten@gmail.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

/**
 * @module moodle-atto_bunnybutton-button
 */

/**
 * Atto text editor bunnybutton plugin.
 *
 * @namespace M.atto_bunnybutton
 * @class button
...
var COMPONENTNAME = 'atto_bunnybutton',
    servername = '',
    courseid = '',
    instancename = '',
    idstring = '',
    ...
    Y.namespace('M.atto_bunnybutton').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
        /**
        ...
        initializer: function () {
            ...
            // Add the bunnybutton icon/buttons.
            this.addButton({
                icon: 'ed/' + icon,
                iconComponent: 'atto_bunnybutton',
                buttonName: icon,
        ...
        /**
         * Display the bunnybutton Dialogue
         *
        ...
        _displayDialogue: function (e, clickedicon) {
            ...
            IFSOURCE = 'https://' + servername +
                    '/bunny/Pages/Sessions/EmbeddedUpload.aspx' + playlistString + instancestring + idstring;
                        ...
                        for (i = 0; i < ids.length; ++i) {
                            ...
                            if (typeof names[i] !== 'undefined') {
                                thumbnailChunk += "<div width='" + sessionWidth + "'>" +
                                    ...
                                    "href='https://" + servername + '/bunny/Pages/Viewer.aspx' + idChunk + instancestring + 
                                    "' target='_blank'>" + names[i] + "</a></div>";
                            }

                            thumbnailChunk += "<a href='https://" + servername + '/bunny/Pages/Viewer.aspx' +
                                idChunk + "' target='_blank'>" +
                                "<img width='128' height='72' alt='" + names[i] + "' src='https://" + 
                                    servername +'/bunny/PublicAPI/SessionPreviewImage?id=' +
                                    ids[i] + "'></img></a><br></div>";

                            objectstring += "<div style='position: relative;'>" +
                                thumbnailChunk +
                                "<div>" + "<iframe src='https://" + servername + '/bunny/Pages/Embed.aspx' +
